...
// pages/DeemedSupervisorApproval.jsx or HODApproval.jsx
import React, { useState } from 'react';
import ApprovalReview from './ApprovalReview';


const DeemedSupervisorApprovalPage = () => {
  ...
  const handleApprove = (comment) => {
    setStatus('approved');
    setComment(comment);
    // dispatch({ type: 'APPROVE_CANDIDATE', payload: { comment } })
  };

  const handleReject = (comment) => {
    setStatus('rejected');
    setComment(comment);
    // dispatch({ type: 'REJECT_CANDIDATE', payload: { comment } })
  };

  return (
    <ApprovalReview
      role="Deemed Supervisor"
...
export default DeemedSupervisorApprovalPage;

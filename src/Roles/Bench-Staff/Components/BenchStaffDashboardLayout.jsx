...
import BenchStaffSidebar from "./BenchStaffSidebar";
import BenchStaffNavbar from "./BenchStaffNavbar";

const BenchStaffDashboardLayout = () => {
...
export default BenchStaffDashboardLayout;

  ...
  return (
    <>
      ...
      >
        ...
        <li className="px-6 py-2 hover:bg-green-600 cursor-pointer text-sm">
              <NavLink to="/dashboard/admin/blacklist-staff">
                Blacklist The Staff
              </NavLink>
        </li>
        <hr className="border-white mx-4" />
        <li className="px-6 py-2 hover:bg-green-600 cursor-pointer text-sm">
              <NavLink to="/dashboard/admin/my-blacklisted-staff">
                My Blacklisted Staff
              </NavLink>
        </li>
        <hr className="border-white mx-4" />
        <li className="px-6 py-2 hover:bg-green-600 cursor-pointer text-sm">
              <NavLink to="/dashboard/admin/undo-requests">
                Undo BlackList Requests
              </NavLink>
        </li>
        <hr className="border-white mx-4" />
